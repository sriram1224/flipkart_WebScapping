    ...
    try {
        ...
        const data = await page.evaluate(() => {
            ...
            productElements.forEach(element => {
                const phoneName = element.querySelector('._4rR01T') ? element.querySelector('._4rR01T').innerText.trim() : '';
                const price = element.querySelector('._30jeq3._1_WHN1') ? element.querySelector('._30jeq3._1_WHN1').innerText.trim() : '';
                const rating = element.querySelector('._3LWZlK') ? element.querySelector('._3LWZlK').innerText.trim() : '';
                const numberOfReviews = element.querySelector('._2_R_DZ span span:last-child') ? element.querySelector('._2_R_DZ span span:last-child').innerText.trim() : '';
